...
public class SwaggerConfig {
    ...
    public OpenAPI openAPIForDev() {
        return new OpenAPI()
                .info(new Info()
                        .title("🏦 REG Electricity system Application API Docs")
                        .description("This is the Swagger documentation for the REG Electricity system Application backend APIs.")
                        .version("1.0.0"))
    ...
    public OpenAPI openAPIForProd() {
        return new OpenAPI()
                .info(new Info()
                        .title("🏦 REG Electricity system Application API Docs")
                        .description("Production API documentation for the RRA Electricity system Application.")
                        .version("1.0.0"))
    ...
    public OpenAPI openAPIForTest() {
        return new OpenAPI()
                .info(new Info()
                        .title("🏦 REG Electricity system Application API Docs")
                        .description("Testing API documentation for the REG Electricity system Application.")
                        .version("1.0.0"))
